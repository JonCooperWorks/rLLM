...
//
// Module structure:
//   loader/mod.rs          — types, LoaderHints, per-layer loaders, main load loop
//   loader/store.rs        — TensorStore, safetensors I/O, is_prequantized_model
//   loader/upload.rs       — tensor upload helpers (bf16/Q4/Q8 auto-detect, sharding)
//   loader/mxfp4.rs        — MXFP4 (FP4 E2M1) dequantization for GPT-OSS
//   loader/vision.rs       — VLM vision encoder weight loading (SigLIP ViT)
//   loader/expert_index.rs — SSD streaming expert index from safetensors headers
// ===========================================================================
...
pub(crate) use upload::{
    ...
    quant_byte_count, quant_row_bytes, quant_dtype_name,
};
...
fn load_weights_maybe_streamed<B: GpuCore>(
    ...
    let expert_index = expert_index::build_expert_index_from_safetensors(
        model_dir, config,
    )?;
